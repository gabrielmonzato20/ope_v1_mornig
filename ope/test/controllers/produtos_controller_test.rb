...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { cor: @produto.cor, descricao: @produto.descricao, marca: @produto.marca, preco: @produto.preco } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { cor: @produto.cor, descricao: @produto.descricao, marca: @produto.marca, preco: @produto.preco } }
