...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { atendente_id: @pedido.atendente_id, cliente_id: @pedido.cliente_id } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { atendente_id: @pedido.atendente_id, cliente_id: @pedido.cliente_id } }
