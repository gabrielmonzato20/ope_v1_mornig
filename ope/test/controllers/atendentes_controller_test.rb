...
class AtendentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atendente" do
    assert_difference('Atendente.count') do
      post atendentes_url, params: { atendente: { email: @atendente.email, nome: @atendente.nome, senha: @atendente.senha } }
    end
  ...
  test "should update atendente" do
    patch atendente_url(@atendente), params: { atendente: { email: @atendente.email, nome: @atendente.nome, senha: @atendente.senha } }
